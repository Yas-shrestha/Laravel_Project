                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                                        disabled aria-describedby="emailHelp" name="category"
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                                        disabled aria-describedby="emailHelp" name="client"
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" class="form-control" id="exampleInputEmail1"
                                                        disabled aria-describedby="emailHelp" name="date"
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" disabled id="exampleFormControlTextarea1" rows="3" name='url'>{{ $portfoliodetails->url }}</textarea>
                                                    @error('url')
                                                        <small>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" disabled id="exampleFormControlTextarea1" rows="3" name='title'>{{ $portfoliodetails->title }}</textarea>
                                                    @error('title')
                                                        <small>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" disabled id="exampleFormControlTextarea1" rows="3" name='description'>{{ $portfoliodetails->description }}</textarea>
                                                    @error('description')
                                                        <small>{{ $message }}</small>
                                                    @enderror
                                                </div>
