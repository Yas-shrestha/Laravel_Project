            ...
            <div class="container-fluid p-4">
                <div class="pagetitle">
                    ...
                    <div class="d-flex justify-content-between">
                        <h1>Index About</h1>
                        <a href="{{ route('about.create') }}" class="btn btn-primary btn-md "><i class="fa fa-plus" aria-hidden="true"></i></a>
                    </div>
                    <nav>
                        <ol class="breadcrumb">
                                ...
                                <table class="table table-striped table-hover table-bordered table-lg table-responsive-lg">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('about.edit',$about->id) }}" class="btn btn-md btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                                <a href="{{ route('about.show',$about->id) }}" class="btn btn-md btn-secondary"><i class="fa fa-eye" aria-hidden="true"></i></a>
