            ...
            <div class="container-fluid p-4">
                <div class="pagetitle">
                    ...
                    <div class="d-flex justify-content-between">
                        <h1>Index Feature</h1>
                        <a href="{{ route('feature.create') }}" class="btn btn-primary btn-md "><i class="fa fa-plus" aria-hidden="true"></i></a>
                    </div>
                    <nav>
                        <ol class="breadcrumb">
                                ...
                                <table class="table table-striped table-hover table-bordered table-lg table-responsive-lg">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $feature->title}}</td>
                                            <td>
                                                <a href="{{ route('feature.edit',$feature->id) }}" class="btn btn-md btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                                <a href="{{ route('feature.show',$feature->id) }}" class="btn btn-md btn-secondary"><i class="fa fa-eye" aria-hidden="true"></i></a>
