                ...
                <div class="container-fluid p-4">
                    <div class="pagetitle">
                        ...
                        <div class="d-flex justify-content-between">
                            <h1>Manage Blogsingles</h1>
                            <a href="{{ route('blogsingle.create') }}" class="btn btn-primary btn-md "><i class="fa fa-plus"
                                    aria-hidden="true"></i></a>
                        </div>
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Home</a></li>
                                <li class="breadcrumb-item active">Manage-blogsingle</li>
                            </ol>
                        </nav>
                    </div><!-- End Page Title -->
                                        ...
                                        <tbody>
                                            @foreach ($blogSingles as $blogsingle)
                                                <tr>
                                                    ...
                                                    <td>{{ $blogsingle->title }}</td>
                                                    <td>{{ $blogsingle->desc }}</td>
                                                    <td><img src="{{ asset('uploads/' . $blogsingle->img) }}" width="120px"
                                                            height="100px" alt="no"></td>
                                                    <td>
                                                        <a href="{{ route('blogsingle.edit', $blogsingle->id) }}"
                                                            class="btn btn-md btn-primary"><i class="fa fa-pencil"
                                                                aria-hidden="true"></i></a>
                                                        <a href="{{ route('blogsingle.show', $blogsingle->id) }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <form
                                                                            action="{{ route('blogsingle.destroy', $blogsingle->id) }}"
