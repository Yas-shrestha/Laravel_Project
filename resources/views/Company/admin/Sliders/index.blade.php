            ...
            <div class="container-fluid p-4">
                <div class="pagetitle">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('slider.create') }}" class="btn btn-primary btn-md "><i class="fa fa-plus" aria-hidden="true"></i></a>
                    </div>
                    <nav>
                        <ol class="breadcrumb">
                                ...
                                <table class="table table-striped table-hover table-bordered table-lg table-responsive-lg">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{asset('uploads/'.$slider->img)}}" width="120px" height="100px" alt="no"></td>
                                            <td>
                                                <a href="{{ route('slider.edit',$slider->id) }}" class="btn btn-md btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                                <a href="{{ route('slider.show',$slider->id) }}" class="btn btn-md btn-secondary"><i class="fa fa-eye" aria-hidden="true"></i></a>
