                ...
                <div class="container-fluid p-4">
                    ...
                    <section class="section">
                        ...
                        <div class="row">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('slider.store', $sliders->id) }}" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    <label for="exampleInputEmail1" disabled
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" disabled id="exampleFormControlTextarea1" rows="3" name='description'>{{ $sliders->title }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
