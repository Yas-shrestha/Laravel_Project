                ...
                <div class="container-fluid p-4">
                    ...
                    <div class="pagetitle">
                        <div class="d-flex justify-content-between">
                            <h1>Edit</h1>
                            <a href="{{ route('team.index') }}" class="btn btn-primary btn-md ">Back</a>
                        </div>
                        <nav>
                            <ol class="breadcrumb">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                                        disabled aria-describedby="emailHelp" name="twitter"
                                                        value="{{ $teams->twitter }}">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                                        disabled aria-describedby="emailHelp" name="facebook"
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                                        disabled aria-describedby="emailHelp" name="instagram"
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                                        disabled aria-describedby="emailHelp" name="linkedin"
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" disabled id="exampleFormControlTextarea1" rows="3" name='post'>{{ $teams->post }}</textarea>
                                                    @error('post')
                                                        <small>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                ...
                                                <img src="/uploads/{{ $teams->img }}" width="120px" height="60px"
                                                    alt="no" class="m-2">
                                                <div class="input-group mb-3 col">
                                                    <input id="imagebox" type="text" class="form-control" disabled
                                                        name="img" readonly value="{{ $teams->img }}">
