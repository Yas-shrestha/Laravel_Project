                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                                        disabled aria-describedby="emailHelp" name="subject"
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea disabled class="form-control" id="exampleFormControlTextarea1" rows="3" name='message'>{{ $contactFrontends->message }}</textarea>
                                                    @error('message')
                                                        <small>{{ $message }}</small>
                                                    @enderror
                                                </div>
