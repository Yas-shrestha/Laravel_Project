                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="name" class="form-control" disabled
                                                        id="exampleInputEmail1" aria-describedby="emailHelp" name="date"
                                                        value="{{ $blogs->date }}">
                                                    @error('date')
                                                        <small>{{ $message }}</small>
                                                    @enderror
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="exampleFormControlTextarea1" disabled rows="3" name='description'>{{ $blogs->description }}</textarea>
                                                    @error('Description')
                                                        <small>{{ $message }}</small>
                                                    @enderror
                                                </div>
